...
- [The-Anomalist/Singularity](https://github.com/The-Anomalist/Singularity)（fork）
- [JackA1ltman/dreamworld_oneplus_sm8250](https://github.com/JackA1ltman/dreamworld_oneplus_sm8250)（借用的修复，Droidspaces+NT Sync实现）
- [KernelSU-Next/KernelSU-Next](https://github.com/KernelSU-Next/KernelSU-Next)
- LineageOS oneplus sm8250 内核树（配置参考）

## Build

- DeepSeek V4 Flash&Pro · OpenCode · $0.76
