...
- 禁用 SUSFS（与 Droidspaces 容器 mount namespace 冲突）
...
- [JackA1ltman/dreamworld_oneplus_sm8250](https://github.com/JackA1ltman/dreamworld_oneplus_sm8250)（借用的修复和Droidspaces+NTSync实现）
...
- DeepSeek V4 Flash&Pro · OpenCode · $0.91
